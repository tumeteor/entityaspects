...
//				aol_impl_out.close();
                for (String key : aol_expl_keyset) {
                    ...
                    if (entries.length == 2 && entries[1].contains("Not event")) {
                        ...
                        if (entries.length > 2 && entries[4].equals("Non-recurrent") && entries[5].equals("Unplanned"))
                            label = "unplanned_nonrecurrent";
                        else if (entries.length > 2 && entries[4].equals("Non-recurrent") && entries[5].equals("Planned"))
                            label = "planned_nonrecurrent";
                        else if (entries.length > 2 && entries[4].equals("Recurrent")) label = "recurrent";
                        else {
                            label = "non-event";
                        }
